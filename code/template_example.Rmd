...
textFileConvert(txt_file = "2023-11-08_180320_110823_19_coryontiles.txt",
                local_path = FALSE,
...
SMR(data = "2023-11-08_180320_110823_19_coryontiles_converted.csv",
    cycle_end = 30, #minutes
    cycle_start = 1,
    first_cycle = "flush",
    chop_start = 60, #take x seconds off from beginning and end of measurement period
    chop_end = 0,
    date_format = c("%d/%m/%Y %H:%M:%S", "GMT"), # PDT
    local_path = FALSE,
